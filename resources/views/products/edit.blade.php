...
@endif
<h1 class="text-primary text-uppercase text-center m-5 text-uppercase">Edit Product # {{$product->name}}</h1>
                    ...
                    <form method="POST" action="{{ url('product/'. $product->id) }}/update" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{old('name',$product->name)}}" placeholder="">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" name="description" id="description" placeholder="">{{old('description',$product->description)}}</textarea>
